...
.. toctree::
   ...
   Writing model agnostic code (COSIMA) <https://cosima-recipes.readthedocs.io/en/latest/tutorials/Model_Agnostic_Analysis.html#gallery-tutorials-model-agnostic-analysis-ipynb>
